...
public class MainView
{
    ...
    {
        get{ return m_showBoxCollider;}
        set{ m_showBoxCollider = value;}
    }
    ...
    public string BackTexture
    {
        set
        {
            ...
            {
                m_background.GetComponent<Renderer>().sharedMaterial.mainTexture = ConfigTool.Instance.GetBackTexture(value);
                m_background.SetActive(m_background.GetComponent<Renderer>().sharedMaterial.mainTexture != null);
            }
        }
    }
