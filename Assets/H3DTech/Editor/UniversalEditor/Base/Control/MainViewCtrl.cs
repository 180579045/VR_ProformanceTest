...
{ 
    ...
    public RenderTexture assistantViewTexture = null;

    public Rect mainViewUVRect = new Rect(0, 0, 1, 1);
    public Rect assistantViewUVRect = new Rect(0, 0, 1, 1);
    ...
    public GameObject axisMeshObj = null;

    public GameObject camObj = null;
    public GameObject assistantCamObj = null;

    public Camera mainCam = null;
    public Camera assistantCam = null;

    public GameObject mainLight = null;
    public GameObject assLight = null;
    ...
    public Vector3 assCentter = new Vector3();
    public float assRadius = 7f;

    public float assistantCamAngleRotateAroundUp = -135.0f;
    public float assistantCamAngleRotateAroundRight = -45.0f;
    public Vector3 assistantCamAngleRotateAngle = new Vector3(-45f, -135f, -0f);
    ...
    public bool IsShowAxis
    {
        get { return isShowAxis; }
    ...
    private void _BuildTestCubeMesh(Mesh mesh)
    {
        if(null == mesh)
        {
            return;
...
//        int[] indices = new int[] { 0, 1, 2, 3 };
        ...
        verts[1].Set(0f, 1f, 0f);
        verts[2].Set(1f, 1f, 0f);
        verts[3].Set(1f, 0f, 0f);
        //verts[4].Set(0f, 0f, 10f);
        //verts[5].Set(0f, 10f, 10f);     
        //verts[6].Set(10f, 10f, 10f);
        //verts[7].Set(10f, 0f, 10f);

        norms[0] = (center - verts[0]).normalized;
        norms[1] = (center - verts[1]).normalized;
        norms[2] = (center - verts[2]).normalized;
        norms[3] = (center - verts[3]).normalized;
        //norms[4] = (center - verts[4]).normalized;
        //norms[5] = (center - verts[5]).normalized;
        //norms[6] = (center - verts[6]).normalized;
        //norms[7] = (center - verts[7]).normalized;

        mesh.vertices = verts;
        mesh.normals = norms;
        //mesh.triangles = new int[] { 0, 1, 2, 0, 2, 3, 3, 2, 6, 3, 6, 7, 7, 6, 4, 7, 5, 4, 4, 5, 0, 4, 1, 0, 1, 5, 6, 1, 6, 2, 7, 3, 0, 7, 0, 4};
    ...
    private static Vector3 _GenMainViewOrigin()
    {
        ...
        s_assistantViewOrigion.x = origin.x + 550;
        return origin;
    }
    ...
    private static string _GenMainViewRootName()
    {
        ...
        axisName = "_MainViewRoot" + mainViewCount.ToString() + "_Axis";
        mainViewCount++;
        return mainViewRootName;
    }

    public static string axisName = string.Empty;
    public static Vector3 s_assistantViewOrigion = new Vector3(10050f, 11000f, 9500f);
    public static int s_layer = 30;
    public static int s_AssLayer = 31;
