Shader "H3D/InGame/Character/RimLightTransparent(Rim Alpha)" {
	Properties {
	...
	Category {
		...
		SubShader {
			...
			void Lod1_surf (Input IN, inout SurfaceOutput o) 
			{
				...
				fixed3 rimrgb = _RimColor.rgb * pow (rim, _RimPower)*_RimColor.a;
				o.Emission = rimrgb; 
				o.Alpha = c.a * _Alpha *  rim;
			}
			ENDCG
		} 
			SubShader {
