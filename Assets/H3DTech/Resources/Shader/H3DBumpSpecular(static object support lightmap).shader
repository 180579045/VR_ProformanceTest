...
Shader "H3D/InGame/SceneStaticObjects/BumpSpecular(support lightmap)" {
	Properties {
	...
	Category{
        ...
        SubShader {
		    ...
		    { 
				...
				fixed4 mc =  tex2D( _MainTex , i.pack0.xy);
				o.Albedo  =  mc.rgb;
				...
				c.rgb += H3DBlinnPhongAdd(o,lightDir,worldViewDir,atten);
