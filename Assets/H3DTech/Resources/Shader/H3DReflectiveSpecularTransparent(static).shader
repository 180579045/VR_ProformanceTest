Shader "H3D/InGame/SceneStaticObjects/ReflectiveSpecularTransparent" {
	 	...
	 	SubShader {
			...
			Pass {
				...
				fixed4 frag_surf (v2f i) : SV_Target
				{
					...
					o.Albedo   = mc.rgb * _Color  + rc*_ReflColor *rc.a *_ReflPower;
    ...
    SubShader {
		...
		Pass {
			...
			fixed4 frag_surf (v2f i) : SV_Target
			{
				...
				c.rgb   = (mc.rgb * _Color + rc.rgb*rc.a *_ReflColor* _ReflPower) * atten;
