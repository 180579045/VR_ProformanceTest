...
Shader "H3D/InGame/SceneDynamicObjects/Unlit/ReflectiveHighLight" {
	Properties 
	{
	...
	SubShader {
		...
		Pass {  
				...
				fixed4 frag (v2f i) : SV_Target
				{
					...
					c.rgb   += c.rgb * H3D_AMBIENT_GETLIGHT(i) + _HighLightColor;
					return c;
				}
				ENDCG
		}
