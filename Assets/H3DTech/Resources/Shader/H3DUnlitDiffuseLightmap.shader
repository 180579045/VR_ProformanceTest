...
Shader "H3D/InGame/SceneStaticObjects/SimpleDiffuse (Supports Lightmap)" {
Properties {
    ...
    Fallback "H3D/InGame/SceneStaticObjects/SimpleDiffuse ( no Supports Lightmap)" //fallback 到不支持lightmap
}
